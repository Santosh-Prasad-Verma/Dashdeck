...
const accounts = [
  ...
  { name: "Stark Industries", mrr: 8900, health: 88, status: "Healthy", contact: "Tony Stark", lastLogin: "30 min ago" },
  { name: "Wayne Enterprises", mrr: 6400, health: 82, status: "Healthy", contact: "Bruce Wayne", lastLogin: "1 day ago" },
];
          ...
          {accounts.map((account) => (
            <div key={account.name} className="rounded-lg border p-3">
              <div className="flex items-center justify-between mb-2">
                ...
                <Badge className={
                  account.status === "Healthy" ? "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-0" :
                  account.status === "At Risk" ? "bg-amber-500/10 text-amber-600 dark:text-amber-400 border-0" :
