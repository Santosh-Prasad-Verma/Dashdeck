    ...
    <div className="grid grid-cols-1 gap-4 *:data-[slot=card]:bg-linear-to-t *:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card *:data-[slot=card]:shadow-xs sm:grid-cols-2 xl:grid-cols-4 dark:*:data-[slot=card]:bg-card">
      <Card>
        ...
        <CardContent className="flex flex-col gap-1.5">
          ...
          <div className="flex items-center gap-1.5 mt-1">
            <Badge className="bg-emerald-500/10 hover:bg-emerald-500/10 text-emerald-500 border-none font-medium text-xs py-0 px-1.5 h-5 flex items-center gap-0.5">
              <TrendingUp className="size-3" />+12.4%
            </Badge>
            <span className="text-[10px] text-muted-foreground font-medium">+$14,200 this month</span>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="flex flex-col gap-1.5">
          ...
          <div className="flex items-center gap-1.5 mt-1">
            ...
            <span className="text-[10px] text-muted-foreground font-medium">+128 new customers</span>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="flex flex-col gap-1.5">
          ...
          <div className="flex items-center gap-1.5 mt-1">
            <Badge className="bg-emerald-500/10 hover:bg-emerald-500/10 text-emerald-500 border-none font-medium text-xs py-0 px-1.5 h-5 flex items-center gap-0.5">
              <TrendingDown className="size-3" />-0.3%
            </Badge>
            <span className="text-[10px] text-muted-foreground font-medium">Below 2.5% target</span>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="flex flex-col gap-1.5">
          ...
          <div className="flex items-center gap-1.5 mt-1">
            <Badge className="bg-emerald-500/10 hover:bg-emerald-500/10 text-emerald-500 border-none font-medium text-xs py-0 px-1.5 h-5 flex items-center gap-0.5">
              <TrendingUp className="size-3" />+7.6%
            </Badge>
            <span className="text-[10px] text-muted-foreground font-medium">+$3.20 this quarter</span>
          </div>
        </CardContent>
      </Card>
    </div>
