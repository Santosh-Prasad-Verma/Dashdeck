  ...
  return (
    <div className="overflow-hidden rounded-xl bg-card shadow-xs ring-1 ring-foreground/10">
      <div className="grid divide-y *:data-[slot=card]:rounded-none *:data-[slot=card]:ring-0 md:grid-cols-2 md:divide-x md:divide-y-0 xl:grid-cols-5">
        <Card>
          <CardHeader>
            <CardTitle className="font-normal text-sm">{t("kpi.uniqueVisitors")}</CardTitle>
            <CardAction>
          ...
          <CardContent className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2 text-muted-foreground text-xs">
              <span>
                {t("from")} <span className="text-foreground">207.3k</span>
              </span>
              <span>•</span>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="font-normal text-sm">{t("kpi.sessions")}</CardTitle>
            <CardAction>
              <Ellipsis className="size-4" />
            </CardAction>
          </CardHeader>
          <CardContent className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2 text-muted-foreground text-xs">
              <span>
                {t("from")} <span className="text-foreground">243.5k</span>
              </span>
              <span>•</span>
              <span>{t("last4Weeks")}</span>
            </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="font-normal text-sm">{t("kpi.pageviews")}</CardTitle>
            <CardAction>
              <Ellipsis className="size-4" />
            </CardAction>
          </CardHeader>
          <CardContent className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2 text-muted-foreground text-xs">
              <span>
                {t("from")} <span className="text-foreground">566.8k</span>
              </span>
              <span>•</span>
              <span>{t("last4Weeks")}</span>
            </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="font-normal text-sm">{t("kpi.engagementRate")}</CardTitle>
            <CardAction>
              <Ellipsis className="size-4" />
            </CardAction>
          </CardHeader>
          <CardContent className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2 text-muted-foreground text-xs">
              <span>
                {t("from")} <span className="text-foreground">58.9%</span>
              </span>
              <span>•</span>
              <span>{t("last4Weeks")}</span>
            </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="font-normal text-sm">{t("kpi.conversionRate")}</CardTitle>
            <CardAction>
              <Ellipsis className="size-4" />
            </CardAction>
          </CardHeader>
          <CardContent className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2 text-muted-foreground text-xs">
              <span>
                {t("from")} <span className="text-foreground">8.9%</span>
              </span>
              <span>•</span>
              <span>{t("last4Weeks")}</span>
            </div>
