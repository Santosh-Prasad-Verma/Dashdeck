  ...
  return (
    <main>
      <div className="grid h-dvh justify-center p-2 lg:grid-cols-2">
        <div className="relative order-2 hidden h-full rounded-3xl bg-zinc-950 border border-zinc-800 lg:flex overflow-hidden">
          {/* Grid Background */}
          ...
          {/* Spotlight Glow */}
          <div className="absolute inset-0 opacity-40 animate-pulse" style={{ backgroundImage: "radial-gradient(circle 450px at 50% 50%, rgba(139, 92, 246, 0.15), transparent 100%)", animationDuration: "10s" }} />
          <div className="absolute top-10 space-y-1 px-10 text-zinc-50 z-10">
          ...
          <div className="absolute bottom-10 flex w-full justify-between px-10 z-10">
