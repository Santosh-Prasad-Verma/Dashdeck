...
function getStatusIcon(status: string) {
  switch (status) {
    case "healthy": return <CheckCircle className="size-4 text-emerald-500" />;
              ...
              <div key={svc.name} className="flex items-center justify-between rounded-lg border p-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground text-xs">{svc.latency} latency · {svc.uptime} uptime</div>
                  </div>
                </div>
