  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm">Manage properties, track occupancy, and monitor portfolio performance.</p>
      </div>

      {/* Quick Stats */}
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        {[
          { icon: Building2, label: "Total Properties", value: "342", color: "text-blue-600 dark:text-blue-400", bg: "bg-blue-500/10" },
          { icon: Home, label: "Occupancy Rate", value: "94.2%", color: "text-emerald-600 dark:text-emerald-400", bg: "bg-emerald-500/10" },
          { icon: DollarSign, label: "Monthly Revenue", value: "$892K", color: "text-purple-600 dark:text-purple-400", bg: "bg-purple-500/10" },
          { icon: Percent, label: "Avg ROI", value: "8.7%", color: "text-amber-600 dark:text-amber-400", bg: "bg-amber-500/10" },
        ].map((stat) => (
