...
export const sidebarItems: NavGroup[] = [
  {
    ...
    items: [
      ...
      {
        titleKey: "Sidebar.items.aiAgents",
      ...
      {
        titleKey: "Sidebar.items.finops",
        url: "/dashboard/finops",
        icon: Coins,
        isNew: true,
      },
      {
      ...
      {
        titleKey: "Sidebar.items.secops",
        url: "/dashboard/secops",
        icon: ShieldCheck,
        isNew: true,
      },
      {
        titleKey: "Sidebar.items.developer",
        url: "/dashboard/developer",
        icon: Terminal,
        isNew: true,
      },
      {
        titleKey: "Sidebar.items.martech",
        url: "/dashboard/martech",
        icon: Target,
        isNew: true,
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        titleKey: "Sidebar.items.reports",
        url: "/dashboard/reports",
        icon: FileBarChart,
        isNew: true,
      },
      {
        titleKey: "Sidebar.items.erd",
        url: "/dashboard/erd",
        icon: Network,
        isNew: true,
      },
