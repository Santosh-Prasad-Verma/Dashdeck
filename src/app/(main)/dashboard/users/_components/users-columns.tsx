...
export const usersColumns: ColumnDef<UserRow>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const deleteUser = useUsersStore.getState().deleteUser;
      return (
        <div className="text-right">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem onClick={() => toast.success(`Viewing profile for ${row.original.name}`)}>
                View profile
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => toast.info(`Edit mode for ${row.original.name}`)}>
                Edit user
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => toast.info(`Managing team for ${row.original.name}`)}>
                Manage team
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => toast.success(`Invite resent to ${row.original.email}`)}>
                Resend invite
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem
