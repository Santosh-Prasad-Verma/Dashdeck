      ...
      <CardContent>
        <ChartContainer config={chartConfig} className="aspect-auto h-64 w-full">
          <LineChart data={chartData} margin={{ top: 0 }}>
            ...
            <Line dataKey="competitorA" type="monotone" stroke="var(--color-competitorA)" strokeWidth={1.5} dot={false} strokeDasharray="5 5" />
            <Line dataKey="competitorB" type="monotone" stroke="var(--color-competitorB)" strokeWidth={1.5} dot={false} strokeDasharray="5 5" />
          </LineChart>
        </ChartContainer>
      </CardContent>
    </Card>
