...
const locations = [
  ...
  },
  {
    ...
    address: "55 E 52nd St, New York, NY",
    type: "Commercial",
    occupancy: 98,
    value: "$5.5M",
    icon: Building2,
  ...
  {
    name: "Willow Creek",
    address: "4500 NE Halsey St, Portland, OR",
    type: "Residential",
    occupancy: 85,
    value: "$1.9M",
    icon: Home,
  },
  {
    ...
    address: "1500 Ocean Dr, Miami, FL",
    type: "Residential",
    occupancy: 78,
    value: "$3.8M",
    icon: Home,
          ...
          {locations.map((loc) => (
            <div key={loc.name} className="flex items-center rounded-lg border p-4 transition-colors hover:bg-muted/50">
              ...
              <div className="text-right">
                ...
                <div className={`text-sm ${loc.occupancy >= 90 ? "text-emerald-600" : "text-amber-600"}`}>
                  {loc.occupancy}% occupied
                </div>
              </div>
            </div>
          ))}
