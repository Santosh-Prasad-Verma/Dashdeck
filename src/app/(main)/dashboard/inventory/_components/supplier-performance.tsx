...
function getStatusBg(status: string) {
  switch (status) {
    ...
    case "Poor": return "bg-red-500/10 text-red-600 dark:text-red-400";
            ...
            <div key={supplier.name} className="rounded-lg border p-3">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2 text-xs">
                  ...
                  <Progress value={supplier.onTime} className={cn("flex-1 h-1.5", `[&>div]:${getScoreColor(supplier.onTime)}`)} />
                ...
                <div className="flex items-center gap-2 text-xs">
                  ...
                  <Progress value={supplier.quality} className={cn("flex-1 h-1.5", `[&>div]:${getScoreColor(supplier.quality)}`)} />
                ...
                <div className="flex items-center gap-2 text-xs">
                  ...
                  <Progress value={supplier.response} className={cn("flex-1 h-1.5", `[&>div]:${getScoreColor(supplier.response)}`)} />
